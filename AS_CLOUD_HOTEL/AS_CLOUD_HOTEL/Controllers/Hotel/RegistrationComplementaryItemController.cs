...
{
    public class RegistrationComplementaryItemController : AppController
    {
         //Datetime formet
        ...
        public RegistrationComplementaryItemController()
        {
        ...
        // SAVE ALL INFORMATION from grid(HML_REGNCI data) TO Asl_lOG Database Table.
        public void Insert_HML_REGNCI_LogData(HML_RegistrationCiDTO model)
        {
            ...
            aslLog.LOGDATA = Convert.ToString("Registration Complementary Item information page. Registration ID: " + model.REGNID + ",\nComplementary Item : " + itemName + ".");
        ...
        // Delete ALL INFORMATION from Grid(HML_REGNCI data) TO Asl_lOG Database Table.
        public void Delete_HML_REGNCI_LogData(HML_RegistrationCiDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        // Delete ALL INFORMATION from HML_REGNCI TO ASL_DELETE Database Table.
        public void Delete_HML_REGNCI_LogDelete(HML_RegistrationCiDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
            ...
            AslDelete.DELDATA = Convert.ToString("Registration Complementary Item information page. Registration ID: " + model.REGNID + ",\nComplementary Item : " + itemName + ".");
        ...
        public JsonResult ComplementaryItemLoad(String regID, String theDate, String companyid)
        {
            ...
            if (list.Count != 0)
            {
                ...
                {
                    var list2 = (from n in db.HmlRegistrationCiDbSet where n.COMPID == comid && n.CITEMID == f.CITEMID && n.REGNID == registrationID select n).ToList();
                    if (list2.Count == 0)
                    {
