...
{
    public class BillHpController : AppController
    {
         //Datetime formet
        ...
        // SAVE ALL INFORMATION from grid(HmlBillHP data) TO Asl_lOG Database Table.
        public void Insert_HML_BILLHP_LogData(HML_BillHpDTO model)
        {
            ...
            aslLog.TABLEID = "HML_BILLHP";
            aslLog.LOGDATA = Convert.ToString("Bill Information Page. Bill Name: " + model.BILLNM + ",\nBill Rate:" + model.BILLRT + ",\nRemarks :" + model.REMARKS + ".");
        ...
        // Edit ALL INFORMATION from Grid(HmlBillHP data) TO Asl_lOG Database Table.
        public void update_HML_BILLHP_LogData(HML_BillHpDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        // Delete ALL INFORMATION from Grid(HmlBillHP data) TO Asl_lOG Database Table.
        public void Delete_HML_BILLHP_LogData(HML_BillHpDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        // Delete ALL INFORMATION from HmlBillHP TO ASL_DELETE Database Table.
        public void Delete_HML_BILLHP_LogDelete(HML_BillHpDTO model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
            ...
            AslDelete.TABLEID = "HML_BILLHP";
            AslDelete.DELDATA = Convert.ToString("Bill Information Page. Bill Name: " + model.BILLNM + ",\nBill Rate:" + model.BILLRT + ",\nRemarks :" + model.REMARKS + ".");
